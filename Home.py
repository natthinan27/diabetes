...
if st.button("ทำนายผล"):
   ...
   if out[0]== 0 :
      ...
      <center><h2 style="border-bottom: 3px solid #31333F;">Prediction Result</h2></center>
      <center><h3 style="border-bottom: 3px solid #31333F; width=100%;">ความเสี่ยงโรคเบาหวานต่ำ</h3></center>
